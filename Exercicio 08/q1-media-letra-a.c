...
****/
int Media(int valor1, int valor2){                     // RESPOSTA: A funcao que calcula a media estah armazenando o resultado em uma variavel inteira//
    int soma = valor1 + valor2;                        // logo ela retorna um valor inteiro e 8.5 em inteiro eh apenas 8.//
    return soma / 2;
}
