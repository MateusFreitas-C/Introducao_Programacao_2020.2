...
****/
float Media(float valor1, float valor2){                                //Substituindo o tipo das funcao e das variveis de int para float acarreta no//
    float soma = valor1 + valor2;                                       // no funcionamento desejado do programa.//
    return soma / 2;
}
